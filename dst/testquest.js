...
var _jsonUnreadableLoader = __webpack_require__(3);
...
var _questguess = __webpack_require__(13);
...
data = EncLoader.decode(__webpack_require__(14));
nodes = document.querySelectorAll('[data-quest="quest"]');
for (var cnt = 0, m = nodes.length; cnt < m; cnt++) {
  quests.push(_quest2.default.quest(nodes[cnt], data));
};

data = EncLoader.decode(__webpack_require__(15));
nodes = document.querySelectorAll('[data-quest="questguess"]');
for (var _cnt = 0, _m = nodes.length; _cnt < _m; _cnt++) {
  quests.push(_questguess2.default.quest(nodes[_cnt], data));
};

data = EncLoader.decode(__webpack_require__(11));
nodes = document.querySelectorAll('[data-quest="questmdz"]');
for (var _cnt2 = 0, _m2 = nodes.length; _cnt2 < _m2; _cnt2++) {
  quests.push(_questmdz2.default.quest(nodes[_cnt2], data));
};
...
module.exports = function (source) {
  ...
  var value = typeof source === "string" ? JSON.parse(source) : source;
   ...
   .replace(/\u2028/g, '\\u2028')
   .replace(/\u2029/g, '\\u2029');
  var out='{"content":"'+Buffer.from(value,"utf8").toString('base64')+'"}';
...
var Quest = function () {
  ...
  _createClass(Quest, [{
    ...
    key: 'calcScore',
    value: function calcScore(checkArr, factArr) {
      var ret = 0;
      checkArr.forEach(function (item, itemId) {
    ...
    value: function calcResults() {
      var score = this.calcScore(this.state.data.results.valid, this.state.answers);
      var results = this.state.data.results.variants.filter(function (item) {
    ...
    value: function drawInit() {
      ...
      var buttons = this.mk({ cls: "buttons", node: page });
      this.mk({ tag: "a", cls: "button", html: data.start, node: buttons }).addEventListener("click", this.doAction.bind(this, this.stages.START), false);
    }
  }, {
    key: 'drawQuest',
    value: function drawQuest() {
      var _this = this;

      var data = this.state.data;
      var questId = this.state.answers.length;
      var quest = data.quests[questId];
      var page = this.mk({ cls: "page", node: this.state.node });
      this.mk({ cls: "title", html: data.title, node: page });
      this.mk({ cls: "note", html: quest.note, node: page });
      quest.answers.forEach(function (item, index) {
        _this.mk({ tag: "a", cls: "answer", html: item.note, node: page }).addEventListener("click", _this.doAction.bind(_this, _this.stages.QUEST, {
          questId: questId,
          answerId: index
        }), false);
      });
    ...
    value: function drawError() {
      var data = this.state.data;
      var page = this.mk({ cls: "page error", node: this.state.node });
      this.mk({ class: "note", html: this.state.errMes, node: page });
      var buttons = this.mk({ cls: "buttons", node: page });
      this.mk({ tag: "a", cls: "button", html: data && data.restart ? data.restart : "Начать сначала", node: buttons }).addEventListener("click", this.doAction.bind(this, this.stages.INIT), false);
    }
  }, {
    key: 'reDraw',
    value: function reDraw() {
    ...
    value: function mk() {
      ...
      var o = Object.assign({}, defOpt, options);
...
module.exports = {"content":""}
